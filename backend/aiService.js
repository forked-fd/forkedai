...
const DEFAULT_SYSTEM_PROMPT =
  'You are Forked AI, an elite AI Assistant developed for precision, clarity, and agency-grade responses. ' +
  'CRITICAL LANGUAGE RULE: Always respond in the EXACT same language the user wrote in — no exceptions. ' +
  'If the user writes in Arabic, respond ENTIRELY in fluent, natural Arabic. ' +
  'If the user writes in English, respond ENTIRELY in English. ' +
  'NEVER mix or include characters from Chinese, Japanese, Korean, Vietnamese, Thai, or any other Asian script. ' +
  'NEVER output raw HTML tags like <p>, <div>, <code> etc. — use Markdown only. ' +
  'Format all responses using clean Markdown: **bold**, *italic*, # headings, - lists, and fenced ```lang code blocks.';

// ─── Response Cleaner ───────────────────────────────────────

/**
 * Removes stray CJK / SE-Asian tokens that some low-quality models
 * hallucinate into otherwise valid Arabic or English responses.
 *
 * Preserves: Arabic (U+0600–U+06FF), Latin (A-Z / a-z), digits, common
 * punctuation, Markdown syntax, code blocks, and whitespace.
 *
 * Strips: CJK Unified Ideographs, Hangul, Hiragana, Katakana, Vietnamese
 * combining marks when they appear isolated inside non-CJK text.
 */
